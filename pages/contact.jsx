...
const Contact = () => {
  ...
  return (
    <>
      <Head>
        <title>Benfill's Portfolio | contact</title>
        ...
        <div className=" px-4 py-2">
              ...
              <div className="card_stylings rounded-xl w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-LightGray text-sm">
                    benfianass@gmail.com
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="md:text-base">Linkedin:</span>
                  <span className="text-LightGray text-sm">Benfill</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="md:text-base">Phone:</span>
                  <span className="text-LightGray text-sm">+212 682673919</span>
                </div>
              </div>
            </div>
          </div>
          <div className="h-16 w-full card_stylings text-xl sm:text-3xl flex gap-x-8 sm:gap-x-16 items-center justify-center text-Snow">
            <a
              ...
              href="mailto:benfianass@gmail.com"
              target="_blank"
              rel="noreferrer"
            >
              <HiMail />
            ...
            <a
              className="hover:scale-125 ease-in-out duration-700"
              href="https://www.linkedin.com/in/benfill/"
              target="_blank"
              rel="noreferrer"
            >
              <FaLinkedin />
        ...
        >
          <div className="flex flex-col items-center justify-center">
            ...
            <a
              ...
              target="_blank"
              href="https://github.com/benfill/portfolio"
            >
